...
#define start_sprint_symbol_offset_offset (start_map_offset_offset + 8)
#define start_sprintf_offset_offset (start_sprint_symbol_offset_offset + 8)
#define start_map_backup_len_offset (start_sprintf_offset_offset + 8)
